...
{
public:
	constant_medium(std::shared_ptr<hittable> b, double d, std::shared_ptr<textrue> a)
	...
	{
		// 调试时偶尔打印样本。要启用，请将enableDebug 设置为true。
		...
		rec.normal = vec3(1, 0, 0);  // 随机的
		rec.front_face = true;     // 随机的
